...
sudo curl -O -L https://github.com/curl -O -L https://github.com/Polkadex-Substrate/parachain/releases/latest/download/polkadot.jsonPolkadex-Substrate/parachain/releases/latest/download/parachain-polkadex-node
sudo curl -O -L https://github.com/Polkadex-Substrate/parachain/releases/latest/download/polkadot-parachain-raw.json
sudo curl -O -L https://github.com/Polkadex-Substrate/parachain/releases/latest/download/polkadot.json
sudo chmod +x parachain-polkadex-node
sudo curl -O -L https://github.com/Polkadex-Substrate/Polkadex/releases/download/v5.1.0/PolkadexNodeUbuntu.zip
...
sudo runuser -u polkadex -- /home/polkadex/parachain-polkadex-node --chain=/home/polkdaex/polkadot-parachain-raw.json --port 40333 --ws-port 9902 --rpc-port 8844 --name "YOURNAMEHERE" --telemetry-url 'wss://telemetry.polkadot.io/submit/ 1' --bootnodes /ip4/3.108.191.170/tcp/40333/p2p/12D3KooWKi39o5WvzPTFz8W2KMqjP5c9HWoY2naYGPVF1YANCFnC -- --execution wasm --chain /home/polkadex/polkadot.json --port 30343 --ws-port 9977 --state-pruning 256 --sync warp
...
User=polkadex
Group=polkadex
ExecStart=/home/polkadex/polkadex-node --validator --chain=/home/polkadex/customSpecRaw.json --name 'YOURNAMEHERE' --telemetry-url 'wss://telemetry.polkadot.io/submit/ 1'
Restart=on-failure
